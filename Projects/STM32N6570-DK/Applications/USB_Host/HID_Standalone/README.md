...
In order to make the program work, you must do the following :
 ...
 - Resort to CubeProgrammer to add a header to the generated binary HID_Standalone_FSBL.bin with the following command
   - *STM32_SigningTool_CLI.exe -bin HID_Standalone_FSBL.bin -nk -of 0x80000000 -t fsbl -o HID_Standalone_FSBL-trusted.bin -hv 2.3 -dump HID_Standalone_FSBL-trusted.bin*
   - The resulting binary is HID_Standalone_FSBL-trusted.bin.
 - Next, in resorting again to CubeProgrammer, load the binary and its header (HID_Standalone_FSBL-trusted.bin) in DK board external Flash at address 0x7000'0000.
