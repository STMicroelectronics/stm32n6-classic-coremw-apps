/**
  ******************************************************************************
  * @file        USB_Device/CustomHID_CDC_ACM_RTOS/USB_Device/Target/usbd_conf.c
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_SetTxFiFo(&hpcd_USB1_OTG_HS, 0, 0x10); // EP0 TX
  HAL_PCDEx_SetTxFiFo(&hpcd_USB1_OTG_HS, 1, 0x80); // EP1 CDC IN
  HAL_PCDEx_SetTxFiFo(&hpcd_USB1_OTG_HS, 2, 0x10); // EP2 CDC CMD IN
  HAL_PCDEx_SetTxFiFo(&hpcd_USB1_OTG_HS, 3, 0x10); // EP3 CustomHID IN
  return USBD_OK;
}
